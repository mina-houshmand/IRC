...
#define RPL_CONNECTED(nickname, prefix) (": 001 " + nickname + " : Welcome to the IRC server!" + prefix + CRLF)
#define RPL_CREATED() (": 003 :This server was created on " + std::string(__DATE__) + " at " + std::string(__TIME__) + CRLF)
#define RPL_UMODEIS(prefix, channelname, mode, user)  ":" + prefix + " MODE " + channelname + " " + mode + " " + user + CRLF
...
#define RPL_CHANGEMODE(prefix, channelname, mode, arguments) (":" + prefix + " MODE " + channelname + " " + mode + " " + arguments + CRLF)
#define RPL_NICKCHANGE(oldnickname, nickname) (":" + oldnickname + " NICK " + nickname + CRLF)
#define RPL_JOINMSG(prefix, channelname) (":" + prefix + " JOIN " + channelname + CRLF)
